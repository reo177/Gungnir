...
os.environ.setdefault("CLIENT_ID",       "CLID")
os.environ.setdefault("CLIENT_SECRET",   "CS")
os.environ.setdefault("SESSION_SECRET",  "SS")
os.environ.setdefault("CALLBACK_URL",    "http://lwa70d3.xyz/auth/callback")
os.environ.setdefault("DASHBOARD_PORT",  "3001")
os.environ.setdefault("LOG_CHANNEL_ID",  "LOG CH ID")
os.environ.setdefault("VERIFY_ROLE_ID",  "VERIFY ROLE")
os.environ.setdefault("VERIFY_CHANNEL_ID","VERIFY CH ID")
